...
public class DemoTest {
	...
	public static void main(String[] args) {
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/mydb","root","Un$ammu#2982");
							System.out.println("Connected successfully");
							Statement stmt=con.createStatement();
							System.out.println("Statement created....");
							
							//Insert query
//							int result= stmt.executeUpdate("insert into employee values(5,'Mahesh',45000)");
//							if(result>0) {
...
//							}
			...
			System.out.println(e);               //toString to display the Exception
		}
