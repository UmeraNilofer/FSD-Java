...
//     pname:string;
//     price:number;
//     constructor(pid:number=0.0,pname:string="Unknown",price:number=25000){
//         this.pid=pid;
//         this.pname=pname;
//         this.price=price;
//     }
//     disProductInfo():void{
//         console.log("Product Object info");
...
class Product {
    ...
    constructor(private pid:number=0.0,public pname:string="Unknown",
