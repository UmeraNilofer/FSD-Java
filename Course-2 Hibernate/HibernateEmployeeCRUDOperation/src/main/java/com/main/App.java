...
//					}	
		...
		//update Query
//					Employee emp2  = session.find(Employee.class, 103);		// select * from employee where id =100;
//					if(emp2==null) {
//						System.out.println("Record not present");
//					}else {
//						Transaction tran = session.getTransaction();
//						tran.begin();
//						
//						emp2.setSalary(19000);			// change salary 
//						
//						session.update(emp2);
//						
//						tran.commit();
...
//					}
		...
		Employee emp2  = session.find(Employee.class, 102);
		if(emp2==null) {
			System.out.println("Record not present");
		}else {
